...
function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreeToTerms) {
      setError(t('mustAgreeToTerms') || 'You must agree to the terms')
      return
    }
  ...
  return (
    <div className="min-h-screen bg-orange-50 flex items-center justify-center px-4 py-8" style={{ backgroundColor: '#fff7ed' }}>
      <div className="w-full max-w-md">
        <h2 className="text-4xl font-bold text-orange-600 mb-8 text-center">Register</h2>
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Sign Up</h3>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                <Icon name="mail" className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400" size="sm" />
                <input
                  type="email"
              ...
              >
                {loading ? t('processing') || 'Processing...' : t('register')}
              </button>
            </form>
            <div className="mt-6">
